...
namespace abNORM.Tests.Core
{
    class Program
    {
    	// This is for running a single Test in the Debugger
        static void Main(string[] args)
        {
            ...
            //new UpdateTest().update();

            //new DBConcurrencyTest().setup();
            //new DBConcurrencyTest().deadLocktest();
            //new DateTimeTest().whereTest();
            //new DBConcurrencyTest().checkDelete();
            //new DBConcurrencyTest().checkUpdateConflict();
        }
    }
}
