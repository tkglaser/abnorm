...
namespace abNORM.Plugins.SQLBased.MSSQL
{
    internal class MSSQLConnection : IConnection
    {
        ...
        {
            DbConnection con = new System.Data.SqlClient.SqlConnection(conString);
        ...
        public ITransaction BeginTransaction()
        {
            return new TransactionTemplate(
                new MSSQLDataProvider(getConnection(), settings), settings);
        }
    }
}
